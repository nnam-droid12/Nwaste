        ...
        <div >
          ...
          <section className="service">
            ...
            <div className="service-container">  
                ...
                />
                <p>
                <a href="https://link.springer.com/article/10.1007/s12230-017-9629-6">Ensusring that the wether condition is compartible with the farmer soil</a>
                </p>
                </div>
            <div className="container-item">
                <HiArrowsExpand 
                    ...
                    size="70px"
                />
                <p><a href="https://www.sciencedirect.com/science/article/pii/S0570178319300375">Reducing the wastage of perishable food through efficient and cost effective storage system</a></p>
            </div>
            <div className="container-item">
                <MdShoppingCart 
                    className="service-icon"
                    size="70px"
                />
                <p><a href="https://foodprint.org/issues/the-problem-of-food-waste/">Reducing the billions of food wasted every year from adverse weather condition</a></p>
            </div>
            <div className="container-item">
                <HiAcademicCap 
                    className="service-icon"
                    size="70px"
                />
                <p ><a href="https://www.fb.org/news/more-farmers-connecting-with-local-buyers-via-websites-and-social-media">We connect farmers to buyers at little or no cost</a></p>
            </div>
        </div>
    </section>
    {/* end of the service */}
